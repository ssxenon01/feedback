        ...
        <article class="container">
            ...
            <div id="login" class="accounts-form">
                ...
                <div class="connect-buttons">
                    <form class="connect-button" name="login" method="post" action="<twitterAuth:url/>"
                          id="twitter-connect-form">
                        <a href="#" onclick="$('#twitter-connect-form').submit();
                        return false;" class="btn" id="twitter_button"><span>Log in with <strong>Twitter</strong></span>
                        </a>
                    </form>

                    <form class="connect-button" name="login" method="post"
                          action="<g:createLink uri="/j_spring_security_facebook_redirect"/>"
                          id="facebook-connect-form">
                        <a href="#" onclick="$('#facebook-connect-form').submit();
                        return false;" class="btn" id="facebook_button"><span>Log in with <strong>Facebook</strong>
                        </span></a>
                    </form>
                </div>
                ...
                <g:form action="regAction" method="POST" name="auth-form" class="user_reg_valid">
                    ...
                    <div class="input">
                        <input id="registerId" type="text" name="registerId" maxlength="75"
                               placeholder="Ригестерийн дугаар">
                    </div>
                    ...
                    <div class="actions clearfix">
                        <input type="submit" value="Бүртгүүлэх" class="btn btn-green">
                    </div>
                </g:form>
            </div>
