    ...
    <div class="span8">
        <div class="w-box">
            <div class="w-box-header">
                Саналын дугаар  <span  class="label label-info">#125151</span>
                <div class="pull-right">
                <a href="#" class="ttip_b" title="Хэвлэх" aria-describedby="ui-tooltip-10">
                    ...
                    <div class="doc_view">
                        <div class="doc_view_header">
                            <dl class="dl-horizontal">
                                ...
                                <dd><span class="label label-info">Шалгагдаж байгаа</span></dd>
                                <dt><i class="icon-tag"></i></dt>
                                <dd><a href="#">Хүнс хөдөө аж ахуй</a>, <a href="#">Банк санхүү</a>, <a href="#">Зам тээвэр</a></dd>
                            </dl>
                        </div>
                        <div class="doc_view_content">
                            1284 гэсэн утас ерөөсөө авахгүй байна. Орон сууц метр кв -ын үнэ 1 сая төгрөг болно гэсэн. Энэ хэзээнээс хэрэгжих вэ? Увс аймгийн Малчин сумын иргэн.
                        </div>
                            ...
                            <div class="user-info">
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <div class="vcard-item">Zoljargal Altantsatsral</div>
                                    </li>

                                    <li>
                                        <span class="item-key">Нэвтрэх нэр</span>
                                        <div class="vcard-item">cosmos</div>
                                    </li>
                                    <li>
                                        <span class="item-key">Регистер</span>
                                        <div class="vcard-item">УЮ87101438</div>
                                    </li>
                                    <li>
                                        <span class="item-key">Имэйл</span>
                                        <div class="vcard-item">a.zoljargal@gmail.com</div>
                                    </li>
                                    <li>
                                        <span class="item-key">Утасны дугаар</span>
                                        <div class="vcard-item">88060487</div>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        ...
                                        <div class="vcard-item">Эрэгтэй</div>
                                    </li>
                                </li>
                                    <li class="v-heading">
                                        Оруулсан саналын тоо <span>(1200)</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                             ...
                             <div class="user-info">
                                 <ul>
                                     <li class="v-heading">
                                         ...
                                         <div class="vcard-item">1455</div>
                                     </li>
                                     <li>
                                         <span class="item-key">Үүссэн</span>

                                         <div class="vcard-item">2013/02/15 02:15</div>
                                     </li>
                                     <li>
