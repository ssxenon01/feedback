            ...
            <div class="w-box">
                <div class="w-box-header w-box-header-userlist clearfix">
                    <div class="pull-left">
                        <div class="input-prepend">
                            ...
                            <input type="text" class="user-list-search search ttip_b" title="Хэрэглэгчийн нэрээр хайх" aria-describedby="ui-tooltip-0" placeholder="Search user">
                        </div>
                    </div>
                ...
                <div class="w-box-content">
                    <table class="table table-striped table-borderP">
                        ...
                        <tr>
                            <td >cosmos.monster</td>
                            <td >Zoljargal Altantsatsral</td>
                            <td >24/04/2012</td>
                            <td >1200</td>
                            <td>
                                <a href="#" class="ttip_b" title="Мэдээлэл харах " title="Edit"><i class="splashy-document_letter_edit"></i></a>
