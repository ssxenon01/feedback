                ...
                <div class="w-box-header w-box-header-userlist clearfix">
                    <div class="pull-left">
                        <div class="input-prepend">
                            ...
                            <input type="text" class="user-list-search search ttip_b" title="Чиглэл хайх" aria-describedby="ui-tooltip-0" placeholder="Нэрээр">
                ...
                <div class="w-box-content">
                    <table class="table table-striped table-borderP">
                        ...
                        <tr>
                            ...
                            <td >24/04/2012</td>
                            <td>
                                <a href="#" class="ttip_b" title="Засах" title="Edit"><i class="splashy-document_letter_edit"></i></a>
                                <a href="#" class="ttip_b" title="Устгах" title="Remove"><i class="splashy-document_letter_remove"></i></a>
                            </td>
                        </tr>
                        <tr>
