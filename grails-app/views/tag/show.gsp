	...
	<body>
		...
		<div id="show-tag" class="content scaffold-show" role="main">
			...
			<ol class="property-list tag">
				...
				<g:if test="${tagInstance?.priority}">
				<li class="fieldcontain">
					<span id="priority-label" class="property-label"><g:message code="tag.priority.label" default="Priority" /></span>
					
						<span class="property-value" aria-labelledby="priority-label"><g:fieldValue bean="${tagInstance}" field="priority"/></span>
